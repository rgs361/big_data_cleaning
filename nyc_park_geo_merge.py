"""
Script to merge geocoded lat/lng from Geocodio CSV back into nyc_park_events.json.
...
# Load the original nyc park events from event_data folder
...
coords_map = {}
with open('event_data_geocodio/nyc_park_geocodio.csv', 'r', encoding='utf-8') as f:
...
with open('event_data_latlng/nyc_park_events_latlng.json', 'w', encoding='utf-8') as f:
    json.dump(events, f, indent=4, ensure_ascii=False)

print(f"✅ Created event_data_latlng/nyc_park_events_latlng.json")
